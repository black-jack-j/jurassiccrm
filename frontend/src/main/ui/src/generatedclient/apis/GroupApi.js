...
var GroupApi = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters.userIdInputTO === null || requestParameters.userIdInputTO === undefined) {
                            throw new runtime.RequiredError('userIdInputTO', 'Required parameter requestParameters.userIdInputTO was null or undefined when calling addUser.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                body: models_1.UserIdInputTOToJSON(requestParameters.userIdInputTO),
                            }, initOverrides)];
                    case 1:
                        response = _a.sent();
    ...
    GroupApi.prototype.createGroupRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters.groupInputTO === null || requestParameters.groupInputTO === undefined) {
                            throw new runtime.RequiredError('groupInputTO', 'Required parameter requestParameters.groupInputTO was null or undefined when calling createGroup.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: models_1.GroupInputTOToJSON(requestParameters.groupInputTO),
                            }, initOverrides)];
                    case 1:
                        response = _a.sent();
    ...
    /**
     */
    GroupApi.prototype.getUsers1Raw = function (initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    /**
     */
    GroupApi.prototype.getUsers1 = function (initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getUsers1Raw(initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters.groupInputTO === null || requestParameters.groupInputTO === undefined) {
                            throw new runtime.RequiredError('groupInputTO', 'Required parameter requestParameters.groupInputTO was null or undefined when calling updateGroup.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
