            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters.taskTO === null || requestParameters.taskTO === undefined) {
                            throw new runtime.RequiredError('taskTO', 'Required parameter requestParameters.taskTO was null or undefined when calling createTask.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: models_1.TaskTOToJSON(requestParameters.taskTO),
                            }, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return models_1.TaskTOFromJSON(jsonValue); })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters.taskTO === null || requestParameters.taskTO === undefined) {
                            throw new runtime.RequiredError('taskTO', 'Required parameter requestParameters.taskTO was null or undefined when calling updateTask.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
