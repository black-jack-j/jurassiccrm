    ...
    UserApi.prototype.createUserRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters.fullUserInputTO === null || requestParameters.fullUserInputTO === undefined) {
                            throw new runtime.RequiredError('fullUserInputTO', 'Required parameter requestParameters.fullUserInputTO was null or undefined when calling createUser.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                body: models_1.FullUserInputTOToJSON(requestParameters.fullUserInputTO),
                            }, initOverrides)];
                    case 1:
                        response = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (requestParameters.fullUserInputTO === null || requestParameters.fullUserInputTO === undefined) {
                            throw new runtime.RequiredError('fullUserInputTO', 'Required parameter requestParameters.fullUserInputTO was null or undefined when calling updateUser.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        headerParameters['Content-Type'] = 'application/json';
